...
public class CeMergingTaskEntity implements Serializable {
    ...
    /**
     * The name of the Core merging Task
     */
    private String name;
    ...
    /**
     * The inputs of the Core merging Task
     */
    @Embedded
    private Inputs inputs = new Inputs();

    /**
     * The artefacts of the Core merging Task computation
     */
    @Embedded
    private Artifacts artifacts = new Artifacts();

    /**
     * The configurations of the Core merging Task
     */
    @Embedded
    private Configurations configurations = new Configurations();

    /**
     * the Outputs of the core merging task
     */
    @Embedded
