...
import com.farao_community.farao.ce_merging.merging.model.hourly.enums.IgmType;
...
public class IgmData implements Serializable {
    ...
    public void setIgmFilePath(final String igmFilePath) {
        checkUcteNameConvention(Paths.get(igmFilePath).getFileName().toString());
        igmFile.feedPathAndName(igmFilePath);
    }
