...
public class BECKeyConfigurationService extends AbstractGridConfigurationService<BECKeyConfigurationRecord, JsonBecConfiguration> {
    ...
    @Override
    protected JsonBecConfiguration getJsonConfigurationFromRecord(final BECKeyConfigurationRecord cfgRecord) {
        return new JsonBecConfiguration(cfgRecord.getBecMatrix());
    }

    @Override
    protected BECKeyConfigurationRecord getConfigurationRecordFromFile(final MultipartFile configurationFile,
