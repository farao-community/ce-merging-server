...
public interface ConfigurationsMapper {
    ...
    Configurations configurationsDtoToConfigurations(ConfigurationsDto configurationsDto);

    ConfigurationsDto configurationsToConfigurationsDto(Configurations configurations);
}
